...
dna <- unnest_extension(occ, "DNADerivedData", fields = c("id", "scientificName", "phylum", "class", "order", "family", "genus", "species", "eventDate"))
...
sequences <- t(sapply(strsplit(as.character(dna_subset$DNA_sequence), ""), tolower))
